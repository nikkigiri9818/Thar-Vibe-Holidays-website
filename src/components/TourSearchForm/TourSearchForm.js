...
const TourSearchForm = () => {
  ...
  return (
    <>
      <form onSubmit={handleSubmit} style={styles.form}>
        <div className="tour-form-inner" style={styles.inner}>

          <div className="tour-form-inputs" style={styles.inputs}>
          ...
          {/* Button */}
          <div className="tour-form-button" style={styles.btnWrap}>
            <button type="submit" style={styles.btn}>
              Send
            </button>
          </div>
