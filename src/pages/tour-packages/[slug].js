...
export const getStaticPaths = () => {
  const paths = tourPackagesData.map((pkg) => ({ params: { slug: pkg.slug } }));
  return { paths, fallback: false };
};

export const getStaticProps = ({ params }) => {
  const tour = tourPackagesData.find((pkg) => pkg.slug === params.slug) || null;
  return { props: { tour } };
};
...
/>
  ...
  >
    ...
    <div style={{ fontSize: "14px", color: "#eee" }}>
      ...
      <Link href="/tour-packages" style={{ color: "#eee", textDecoration: "none" }}>Tour Packages</Link>
      <span style={{ margin: "0 8px" }}>»</span>
      ...
      <div className="container" style={{ display: "flex", gap: "35px", flexWrap: "wrap", paddingTop: "50px", paddingBottom: "60px" }}>
        ...
        <div style={{ flex: "1 1 620px" }}>
          ...
          <div style={{ padding: "25px 5px" }}>
            ...
            {activeTab === "itinerary" && (
              <>
                <h3 style={{ marginTop: 0, marginBottom: "26px" }}>Itinerary</h3>
            ...
            {activeTab === "inclusion" && (
              <>
                <h3 style={{ marginTop: 0, marginBottom: "25px" }}>Inclusion</h3>
            ...
            {activeTab === "exclusion" && (
              <>
                <h3 style={{ marginTop: 0, marginBottom: "25px" }}>Exclusion</h3>
                <ul style={{ paddingLeft: "20px", color: "#555", lineHeight: 2 }}>
        ...
        <div style={{ flex: "0 1 300px" }}>
          ...
          <div style={{ border: "1px solid #eee", borderRadius: "8px", padding: "22px", boxShadow: "0 6px 18px rgba(0,0,0,0.06)" }}>
            <h3 style={{ marginTop: 0, marginBottom: "14px", fontSize: "17px" }}>Other Tours</h3>
            {tourPackagesData.map((p) => (
              <Link
                key={p.id}
                href={`/tour-packages/${p.slug}`}
                style={{
                  display: "block",
                  padding: "10px 0",
